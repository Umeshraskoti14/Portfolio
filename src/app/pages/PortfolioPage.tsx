...
const communityCampaignImg = '/assets/Visual Storytelling/heritage/heritage-1.webp';
...
const portfolioData = {
  'Community Impact': {
    ...
    'Community Empowerment': [
      ...
      { title: 'Beijing+ 30 Review Consultation', description: 'I had the valuable opportunity to participate in the Beijing+30 Review Consultation as a Rapporteur, organized by Beyond Beijing Committee Nepal and held in Dang and Dhangadhi. This experience gave me direct exposure to Nepal\'s ongoing journey toward achieving the commitments of the Beijing Declaration and Platform for Action (1995) and understanding the realities of gender equality from grassroots to policy level. As a Rapporteur, I was responsible for documenting discussions, key recommendations, participant perspectives, and major thematic findings shared by representatives from government agencies, civil society organizations, women\'s rights activists, youth leaders, and community stakeholders. Through these consultations, it became clear that Nepal has made important progress over the last three decades in areas such as women\'s political participation through inclusive constitutional provisions, increased representation in local governments, improved access to education for girls, stronger legal protections against domestic violence, trafficking, child marriage, and discrimination, as well as significant improvements in maternal and reproductive health services. At the same time, the consultations highlighted persistent and deeply rooted challenges, including gender-based violence, unequal economic opportunities, wage gaps, limited access to land and financial resources, unpaid care burdens on women, and multiple forms of discrimination faced by women from Dalit, Indigenous, Madhesi, rural, disability, and other marginalized communities. Participants strongly emphasized that while policies and legal frameworks exist, implementation gaps remain one of Nepal\'s greatest obstacles. The consultation also stressed the growing need to address digital inequality, climate vulnerability, migration-related risks, and the importance of involving youth in advancing gender equality and Sexual and Reproductive Health and Rights (SRHR). My role as Rapporteur strengthened my skills in active listening, documentation, analytical reporting, and synthesizing diverse voices into clear recommendations. More importantly, it deepened my understanding that the Beijing+30 Review is not only a reflection on past achievements, but also a strategic opportunity for Nepal to renew commitments and transform promises into measurable actions that ensure dignity, safety, leadership, and equal opportunities for all women and girls. Being part of this consultation in Dang and Dhangadhi was both professionally enriching and personally inspiring, as it reinforced my commitment to social justice, inclusive development, and meaningful advocacy for gender equality in Nepal.', image: '/assets/Community Impact/Community Empowerment/beijing-30-review-consultation.webp', tags: ['Rapporteur', 'Gender Equality', 'Beijing+30'], icon: Users },
    ],
  },
  ...
  'Visual Storytelling': {
    'Cultural Heritage': [
      { title: 'Architectural Photography - Temples & Landmarks', description: 'Documenting Nepal\'s rich architectural heritage through professional photography of ancient temples, cultural landmarks, and historical sites. Preserving the visual legacy of traditional Nepali architecture and cultural monuments.', images: [{ src: '/assets/Visual Storytelling/heritage/heritage-1.webp', name: 'Heritage 1' }, { src: '/assets/Visual Storytelling/heritage/heritage-2.webp', name: 'Heritage 2' }, { src: '/assets/Visual Storytelling/heritage/heritage-3.webp', name: 'Heritage 3' }, { src: '/assets/Visual Storytelling/heritage/heritage-4.webp', name: 'Heritage 4' }, { src: '/assets/Visual Storytelling/heritage/heritage-5.webp', name: 'Heritage 5' }, { src: '/assets/Visual Storytelling/heritage/heritage-6.webp', name: 'Heritage 6' }, { src: '/assets/Visual Storytelling/heritage/heritage-7.webp', name: 'Heritage 7' }, { src: '/assets/Visual Storytelling/heritage/heritage-8.webp', name: 'Heritage 8' }, { src: '/assets/Visual Storytelling/heritage/heritage-9.webp', name: 'Heritage 9' }], tags: ['Heritage', 'Architecture', 'Culture'], icon: Camera },
    ],
    'Landscape & Nature': [
      { title: 'Himalayan Landscapes', description: 'Capturing the majestic beauty of Nepal\'s mountain ranges and natural wonders. Professional landscape photography showcasing the Himalayas in their full glory.', images: [{ src: '/assets/Visual Storytelling/himalayas/himalayas-1.webp', name: 'Himalayas 1' }, { src: '/assets/Visual Storytelling/himalayas/himalayas-2.webp', name: 'Himalayas 2' }, { src: '/assets/Visual Storytelling/himalayas/himalayas-3.webp', name: 'Himalayas 3' }, { src: '/assets/Visual Storytelling/himalayas/himalayas-4.webp', name: 'Himalayas 4' }, { src: '/assets/Visual Storytelling/himalayas/himalayas-5.webp', name: 'Himalayas 5' }, { src: '/assets/Visual Storytelling/himalayas/himalayas-6.webp', name: 'Himalayas 6' }, { src: '/assets/Visual Storytelling/himalayas/himalayas-7.webp', name: 'Himalayas 7' }, { src: '/assets/Visual Storytelling/himalayas/himalayas-8.webp', name: 'Himalayas 8' }, { src: '/assets/Visual Storytelling/himalayas/himalayas-9.webp', name: 'Himalayas 9' }, { src: '/assets/Visual Storytelling/himalayas/himalayas-10.webp', name: 'Himalayas 10' }, { src: '/assets/Visual Storytelling/himalayas/himalayas-11.webp', name: 'Himalayas 11' }], tags: ['Landscape', 'Mountains', 'Himalayas'], icon: Camera },
      { title: 'Golden Hour - Sunrise Mountain Peaks', description: 'Golden hour photography of Nepal\'s iconic mountain landscapes. Capturing the magical moments when sunlight kisses the peaks.', images: [{ src: '/assets/Visual Storytelling/sunrise/sunrise1.webp', name: 'Sunrise 1' }, { src: '/assets/Visual Storytelling/sunrise/sunrise2.webp', name: 'Sunrise 2' }, { src: '/assets/Visual Storytelling/sunrise/sunrise3.webp', name: 'Sunrise 3' }, { src: '/assets/Visual Storytelling/sunrise/sunrise4.webp', name: 'Sunrise 4' }, { src: '/assets/Visual Storytelling/sunrise/sunrise5.webp', name: 'Sunrise 5' }, { src: '/assets/Visual Storytelling/sunrise/sunrise6.webp', name: 'Sunrise 6' }, { src: '/assets/Visual Storytelling/sunrise/sunrise7.webp', name: 'Sunrise 7' }, { src: '/assets/Visual Storytelling/sunrise/sunrise8.webp', name: 'Sunrise 8' }, { src: '/assets/Visual Storytelling/sunrise/sunrise9.webp', name: 'Sunrise 9' }, { src: '/assets/Visual Storytelling/sunrise/sunrise10.webp', name: 'Sunrise 10' }, { src: '/assets/Visual Storytelling/sunrise/sunrise11.webp', name: 'Sunrise 11' }, { src: '/assets/Visual Storytelling/sunrise/sunrise12.webp', name: 'Sunrise 12' }, { src: '/assets/Visual Storytelling/sunrise/sunrise13.webp', name: 'Sunrise 13' }, { src: '/assets/Visual Storytelling/sunrise/sunrise14.webp', name: 'Sunrise 14' }, { src: '/assets/Visual Storytelling/sunrise/sunrise15.webp', name: 'Sunrise 15' }, { src: '/assets/Visual Storytelling/sunrise/sunrise16.webp', name: 'Sunrise 16' }], tags: ['Sunrise', 'Mountains', 'Golden Hour'], icon: Camera },
      { title: 'Forest & Nature Biodiversity', description: 'Exploring the lush forests and natural beauty of Nepal\'s diverse ecosystems. Environmental photography celebrating biodiversity.', images: [{ src: '/assets/Visual Storytelling/nature/nature1.webp', name: 'Dense Forest Canopy' }, { src: '/assets/Visual Storytelling/nature/nature3.webp', name: 'Moss-Covered Trees' }, { src: '/assets/Visual Storytelling/nature/nature5.webp', name: 'Alpine Meadow Flora' }, { src: '/assets/Visual Storytelling/nature/nature6.webp', name: 'Forest Stream Habitat' }, { src: '/assets/Visual Storytelling/nature/nature7.webp', name: 'Rocky Forest Gorge' }, { src: '/assets/Visual Storytelling/nature/nature8.webp', name: 'Green Valley Forest' }, { src: '/assets/Visual Storytelling/nature/nature9.webp', name: 'Forest Detail Close-up' }, { src: '/assets/Visual Storytelling/nature/nature11.webp', name: 'Morning Mist Forest' }, { src: '/assets/Visual Storytelling/nature/nature14.webp', name: 'Biodiversity Rich Scene' }], tags: ['Nature', 'Forest', 'Environment'], icon: Camera },
    ],
    'Documentary Photography': [
      { title: 'Rural Nepal Village Life', description: 'Documentary photography showcasing the authentic life in Nepal\'s countryside. Capturing the essence of rural communities and their daily lives.', images: [{ src: '/assets/Visual Storytelling/rural/rural1.webp', name: 'Rural 1' }, { src: '/assets/Visual Storytelling/rural/rural2.webp', name: 'Rural 2' }, { src: '/assets/Visual Storytelling/rural/rural3.webp', name: 'Rural 3' }, { src: '/assets/Visual Storytelling/rural/rural4.webp', name: 'Rural 4' }, { src: '/assets/Visual Storytelling/rural/rural5.webp', name: 'Rural 5' }, { src: '/assets/Visual Storytelling/rural/rural6.webp', name: 'Rural 6' }, { src: '/assets/Visual Storytelling/rural/rural7.webp', name: 'Rural 7' }, { src: '/assets/Visual Storytelling/rural/rural8.webp', name: 'Rural 8' }, { src: '/assets/Visual Storytelling/rural/rural9.webp', name: 'Rural 9' }, { src: '/assets/Visual Storytelling/rural/rural10.webp', name: 'Rural 10' }, { src: '/assets/Visual Storytelling/rural/rural11.webp', name: 'Rural 11' }, { src: '/assets/Visual Storytelling/rural/rural12.webp', name: 'Rural 12' }, { src: '/assets/Visual Storytelling/rural/rural13.webp', name: 'Rural 13' }, { src: '/assets/Visual Storytelling/rural/rural14.webp', name: 'Rural 14' }, { src: '/assets/Visual Storytelling/rural/rural15.webp', name: 'Rural 15' }, { src: '/assets/Visual Storytelling/rural/rural16.webp', name: 'Rural 16' }, { src: '/assets/Visual Storytelling/rural/rural17.webp', name: 'Rural 17' }, { src: '/assets/Visual Storytelling/rural/rural18.webp', name: 'Rural 18' }, { src: '/assets/Visual Storytelling/rural/rural19.webp', name: 'Rural 19' }, { src: '/assets/Visual Storytelling/rural/rural20.webp', name: 'Rural 20' }, { src: '/assets/Visual Storytelling/rural/rural21.webp', name: 'Rural 21' }, { src: '/assets/Visual Storytelling/rural/rural22.webp', name: 'Rural 22' }, { src: '/assets/Visual Storytelling/rural/rural23.webp', name: 'Rural 23' }, { src: '/assets/Visual Storytelling/rural/rural24.webp', name: 'Rural 24' }, { src: '/assets/Visual Storytelling/rural/rural25.webp', name: 'Rural 25' }, { src: '/assets/Visual Storytelling/rural/rural26.webp', name: 'Rural 26' }], tags: ['Documentary', 'Village Life', 'Rural Nepal'], icon: Camera },
      { title: 'Professional Portraiture & Events', description: 'Professional event and portrait photography using Canon, Nikon, Sony, and Pentax systems. Capturing moments that matter in leadership, community events, and character-driven storytelling.', images: [{ src: '/assets/Visual Storytelling/professional/professional1.webp', name: 'Professional 1' }, { src: '/assets/Visual Storytelling/professional/professional2.webp', name: 'Professional 2' }, { src: '/assets/Visual Storytelling/professional/professional3.webp', name: 'Professional 3' }, { src: '/assets/Visual Storytelling/professional/professional4.webp', name: 'Professional 4' }, { src: '/assets/Visual Storytelling/professional/professional5.webp', name: 'Professional 5' }, { src: '/assets/Visual Storytelling/professional/professional6.webp', name: 'Professional 6' }, { src: '/assets/Visual Storytelling/professional/professional7.webp', name: 'Professional 7' }, { src: '/assets/Visual Storytelling/professional/professional8.webp', name: 'Professional 8' }, { src: '/assets/Visual Storytelling/professional/professional9.webp', name: 'Professional 9' }], tags: ['Professional', 'Training Sessions', 'Portraits'], icon: Camera },
    ],
  },
};
